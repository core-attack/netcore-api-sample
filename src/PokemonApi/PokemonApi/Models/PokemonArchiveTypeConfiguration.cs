...
{
    public class PokemonArchiveTypeConfiguration : IEntityTypeConfiguration<PokemonArchive>
    {
        public void Configure(EntityTypeBuilder<PokemonArchive> builder)
        {
            if (builder == null)
            {
            ...
            builder.ToTable("PokemonArchive");
